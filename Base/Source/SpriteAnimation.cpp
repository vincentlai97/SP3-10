...
void SpriteAnimation::Render()
{
	...
	if(mode == DRAW_LINES)
		glDrawElements(GL_LINES, 4, GL_UNSIGNED_INT, (void*)(m_currentFrame * 4 * sizeof(GLuint)));
	else if(mode == DRAW_TRIANGLE_STRIP)
		glDrawElements(GL_TRIANGLE_STRIP, 4, GL_UNSIGNED_INT, (void*)(m_currentFrame * 4 * sizeof(GLuint)));
	else
